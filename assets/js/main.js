...
(function ($) {
  ...
  // Simple image lightbox (single initialization)
  (function () {
    var $overlay = $(
      '<div class="lightbox-overlay" aria-hidden="true"><button class="lightbox-close" aria-label="Schließen"><i class="fas fa-times" aria-hidden="true"></i></button><img src="" alt=""/></div>',
    );
    $body.append($overlay);
    ...
    // Open on click
    $(document).on("click", ".image.fit img, .image.main img", function (e) {
      e.preventDefault();
